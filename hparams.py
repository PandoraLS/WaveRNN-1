...
wav_path = '/path/to/wav_files/' #'/path/to/wav_files/'  LJSpeech-1.1/文件夹路径
data_path = 'data/' # 'data/' 处理后数据的文件夹
# wav_path = '/Users/lisen/workspace/datasets/LJSpeech-1.1' #'/path/to/wav_files/'  LJSpeech-1.1/文件夹路径
# data_path = '/Users/lisen/workspace/datasets/fatchord_wavernn_LJ_output' # 'data/' 处理后数据的文件夹
