...
wav_path = '/home/lizhen/ll_workspace/datasets/CHINESE_MANDARIN' #'/path/to/wav_files/'  LJSpeech-1.1/文件夹路径
data_path = '/home/lizhen/ll_workspace/datasets/fatchord_wavernn_CHINESE_MANDARIN_output' # 'data/' 处理后数据的文件夹
